    ...
    public String checkGameWinner(char [][]grid){
        String result = "None";
            ...
            if ((grid[0][0] & grid[0][1] & grid[0][2]) == 'o') {
                ...
                result = "O wins";
            } else if ((grid[0][0] & grid[0][1] & grid[0][2]) == 'x') {
                result = "X wins";
            } else if ((grid[1][0] & grid[1][1] & grid[1][2]) == 'x') {
                result = "X wins";
            } else if ((grid[2][0] & grid[2][1] & grid[2][2]) == 'x') {
                result = "X wins";
            } else if ((grid[0][0] & grid[1][0] & grid[2][0]) == 'x') {
                result = "X wins";
            } else if ((grid[0][1] & grid[1][1] & grid[2][1]) == 'x') {
                result = "X wins";
            } else if ((grid[0][2] & grid[1][2] & grid[2][2]) == 'x') {
                result = "X wins";
            } else if ((grid[0][0] & grid[1][1] & grid[2][2]) == 'x') {
                result = "X wins";
            } else if ((grid[0][2] & grid[1][1] & grid[2][0]) == 'x') {
                result = "X wins";
            } else if(freeSpots==0){
                result = "It's a TIE!";
            }
